...
@interface DYUserInfoHeader ()

@property (nonatomic, strong) UIView                  *containerView;
@end
@implementation DYUserInfoHeader
...
- (void) initAvatarBackground {
    ...
    _topBackground.image = [UIImage imageNamed:@"default_emoticon_cover"];
...
-(UIBezierPath *)createBezierPath {
    ...
    [bezierPath addArcWithCenter:CGPointMake(25 + avatarRadius * cos(M_PI/4), avatarRadius * sin(M_PI/4) + topOffset)
                          radius:avatarRadius
                      startAngle:(M_PI * 5)/4
                        endAngle:(M_PI * 7)/4
                       clockwise:YES];
